      ...
      <div className="flex flex-col justify-center space-y-6">
        ...
        <div className="space-y-4 text-neutral-300">
          <p className="leading-relaxed hover:bg-neutral-800/50 transition-colors duration-300 p-4 rounded-xl">
            ...
            . Passionné par le développement web full-stack avec une orientation
            front-end.
          </p>
        ...
        <div className="flex space-x-4 mt-4">
          <button className="flex items-center px-6 py-3 bg-gradient-to-r from-purple-500 to-blue-500 rounded-lg hover:scale-105 transition-transform duration-300">
